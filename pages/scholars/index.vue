...
const scholars_store = useScholarsStore();
...
const scholars = computed(() => {
	return scholars_store.getScholars();
});
...
const handleDeleteScholar = () => {
	...
	scholars_store.deleteScholar(selectedScholar.value.id);
